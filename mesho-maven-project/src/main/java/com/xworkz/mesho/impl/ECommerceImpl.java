package com.xworkz.mesho.impl;

import com.xworkz.mesho.dto.CustomerDTO;
...
public class ECommerceImpl implements ECommerceMesho
{
    ...
    public CustomerDTO getCustomerByNumber(long phoneNumber) {
        ...
        try{
            con= DriverManager.getConnection("jdbc:mysql://localhost:3306/xworkz","root","Xworkzodc@123");
            stmt=con.prepareStatement("select customer_name from customer_table where phone_number=?");
    ...
    public CustomerDTO getCustomerById(int id) {
        ...
        try{
            con= DriverManager.getConnection("jdbc:mysql://localhost:3306/xworkz","root","Xworkzodc@123");
            stmt=con.prepareStatement("select customer_name from customer_table where customer_id=?");
            stmt.setLong(1,id);
    ...
    public CustomerDTO getCustomerByEmail(String email) {
        ...
        try{
            con= DriverManager.getConnection("jdbc:mysql://localhost:3306/xworkz","root","Xworkzodc@123");
            stmt=con.prepareStatement("select customer_name from customer_table where customer_email=?");
